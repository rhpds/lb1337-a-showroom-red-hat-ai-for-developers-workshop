...
----
quarkus.langchain4j.openai.parasol-instruct.chat-model.model-name=parasol-4
quarkus.langchain4j.openai.parasol-instruct.base-url={parasol-instruct-url}/v1
...
Open the `routes.tsx` file in the `src/main/webui/src/app` directory and `uncomment` the following code out to show the new menu item.
