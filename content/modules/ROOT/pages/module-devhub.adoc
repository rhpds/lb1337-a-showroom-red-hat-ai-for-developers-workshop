...
Go back to your parasol component on the Red Hat Developer Hub: https://developer-hub-backstage-globex-devhub.{openshift_subdomain}/catalog/default/component/parasol-app-{user}[Red Hat Developer Hub UI^].
