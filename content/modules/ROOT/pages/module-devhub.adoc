...
Go back to your frontend component on the Red Hat Developer Hub: https://backstage-backstage.{openshift_subdomain}/catalog/default/component/frontend-app-{user_name}[Red Hat Developer Hub UI^].
