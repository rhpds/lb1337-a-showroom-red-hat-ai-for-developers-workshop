...
Let's change our model to an untrained model.  To do this, open the file .vscode/settings.json and replace the contents with:
...
IMPORTANT: Before we move on, replace the .vscode/settings.json file with the contents below:
