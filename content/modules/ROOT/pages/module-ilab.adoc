...
If you dont have VSCode open as explained in section 3.2, You can open it again following the instructions below:
...
image::ilab/ilab-taxonomy-create-folder.png[New folder] 
