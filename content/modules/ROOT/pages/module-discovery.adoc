...
=== 2.1 Launch Podman Desktop AI Lab

1. Click the `Activities` label in the top-left corner of the screen.
2. Click the `Show Applications` icon to show all the applications.
3. Click the `Podman Desktop` icon to launch Podman Desktop.
...
=== 2.4. Testing out Playground Environments
