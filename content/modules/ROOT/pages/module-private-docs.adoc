...
We have already added the policy documents in the app/src/main/resources/policies folder. Now we need to tell the Easy Rag extension where to find them by adding the following line to your app/src/main/resources/application.properties:
