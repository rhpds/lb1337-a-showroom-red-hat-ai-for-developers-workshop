...
** *forwardAddress* - where the email should be forwarded to based on the content of the message
** *customerComment* - what message should be included at the top of the email indicating to the customer explaining why the message is being forwarded
* Scenarios:
...
`{ "claimStatus": "NEW", "forwardAddress": "new.claim@parasol.com", "customerComment": "<Customer Comment>" }`

`{ "claimStatus": "EXISTING", "forwardAddress": "existing.claim@parasol.com", "customerComment": "<Customer Comment>" }`

`{ "claimStatus": "UNRELATED", "forwardAddress": "customer.service@parasol.com", "customerComment": "<Customer Comment>" }`

`{ "claimStatus": "UNKNOWN", "forwardAddress": "discard@parasol.com", "customerComment": "<Customer Comment>" }`
...
{ "claimStatus": "NEW", "forwardAddress": "\new.claim@parasol.com", "customerComment": "<Customer Comment>" }
...
{ "claimStatus": "NEW", "forwardAddress": "\new.claim@parasol.com", "customerComment": "We hope you and the other party are ok!   I'm forwarding your note to a team that can assist you with your claim." }
----
